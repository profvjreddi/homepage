...
![Effective research meetings.](/images/blog/eff-meetings.png)
...
> ### 📋 Meeting Brief: LLM Inference Optimization
> 
> **Project Goal:** Achieve a 10x inference speedup while maintaining accuracy (a totally BS example)
> 
> **This Week's Results:**
...
> ### 📝 Meeting Minutes: LLM Inference Optimization
> 
> **Date:** August 7, 2025 | **Attendees:** Alex, Sarah, PI
> 
> **Context:**  
> Testing quantization methods to speed up our LLM inference pipeline. 4-bit quantization shows 3x speedup but unexpected accuracy drops on math benchmarks.
> 
> **Key Insights:**
...
Effective research meetings respect everyone's time, move projects forward, and build collaboration. You're not expected to have all the answers, but you are expected to come prepared, give context quickly, engage the group, and leave with clear next steps.
...
> **A Note on PI Styles:** This advice works well for my style, but every PI is different. Some prefer highly structured updates; I prefer seeing how you think through problems. The preparation and clarity principles still apply—come ready to engage, communicate what's working for you, and we'll find the right balance together.

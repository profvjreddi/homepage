        ...
        <div className="max-w-4xl mx-auto px-6 py-12">
          ...
          <div className="text-center mb-8">
            <a 
              ...
              className="inline-flex items-center px-4 py-2 text-sm font-medium text-[#A51C30] border border-[#A51C30] rounded-md hover:bg-[#A51C30] hover:text-white transition-colors duration-200"
              target="_blank"

        ...
        <div className="max-w-4xl mx-auto px-6 py-12">
          ...
          <div className="text-center mb-12">
            <a 
              ...
              className="inline-flex items-center px-8 py-4 bg-[#A51C30] text-white text-lg font-semibold rounded-lg hover:bg-[#8B1A2B] transition-colors shadow-lg hover:shadow-xl transform hover:scale-105 transition-all duration-200"
              target="_blank"
